pub mod OpenGl {
    ...
    use crate::{ndarray_abstractions::MyArray::N as nd_trait, vertices};
    use crate::vertices::Vertices::{V7, V10, Vertex};
    ...
    impl WithObject<'_> {
        ...
        pub fn vao(opengl:&Gl, vao:u32) -> WithObject {
            bind_vertex_array(opengl, vao);
            WithObject { opengl, object_type:GlSettings::VertexArrayObject, vao_id:vao, vbo_id:0 }
        }
        pub fn vbo(opengl:&Gl, vbo:u32) -> WithObject {
            bind_buffer(opengl, GlSettings::ArrayBuffer, vbo);
            WithObject { opengl, object_type:GlSettings::VertexBufferObject, vao_id:0, vbo_id:vbo }
        }
        ...
        pub fn buffer_data(&self, target:GlSettings, data:&Vec<f32>, draw_type:GlSettings) {
            let data_size = (data.len() * std::mem::size_of::<f32>()) as gl::types::GLsizeiptr;
        ...
        pub fn draw_vao(&self, mode:GlSettings, data:&Vec<f32>) {
    ...
    pub fn get_compilation_error(opengl:&Gl, id:u32, shader_type:ShaderType)
    ...
    pub fn get_uniform_location(opengl:&Gl, program_id:u32, uniform_name:&str) -> i32 {
    ...
    pub fn set_uniform_float(opengl:&Gl, program_id:u32, uniform_name:&str, float:*const f32) {
