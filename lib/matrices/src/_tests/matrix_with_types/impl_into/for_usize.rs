...
impl Into<Matrix<u64>> for Matrix<usize>{
...
impl Into<Matrix<u128>> for Matrix<usize>{
...
impl Into<Matrix<i64>> for Matrix<usize>{
...
impl Into<Matrix<i128>> for Matrix<usize>{
...
impl Into<Matrix<u32>> for Matrix<usize>{
...
impl Into<Matrix<f32>> for Matrix<usize>{
...
impl Into<Matrix<f64>> for Matrix<usize>{
