...
impl Into<Matrix<i64>> for Matrix<isize>{
...
impl Into<Matrix<i128>> for Matrix<isize>{
...
impl Into<Matrix<i32>> for Matrix<isize>{
...
impl Into<Matrix<f32>> for Matrix<isize>{
...
impl Into<Matrix<f64>> for Matrix<isize>{
