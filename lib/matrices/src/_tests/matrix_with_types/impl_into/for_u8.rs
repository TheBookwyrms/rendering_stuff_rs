...
impl Into<Matrix<u16>> for Matrix<u8>{
    fn into(self) -> Matrix<u16> {
        let narr = (0..self.array.len()).map(|i| self.array[i] as u16).collect::<Vec<_>>();
        Matrix { shape:self.shape, array:narr, dtype:DataTypes::U16 }
    }
}

impl Into<Matrix<u32>> for Matrix<u8>{
...
impl Into<Matrix<u64>> for Matrix<u8>{
...
impl Into<Matrix<u128>> for Matrix<u8>{
...
impl Into<Matrix<i16>> for Matrix<u8>{
    fn into(self) -> Matrix<i16> {
        let narr = (0..self.array.len()).map(|i| self.array[i] as i16).collect::<Vec<_>>();
        Matrix { shape:self.shape, array:narr, dtype:DataTypes::I16 }
    }
}

impl Into<Matrix<i32>> for Matrix<u8>{
...
impl Into<Matrix<i64>> for Matrix<u8>{
...
impl Into<Matrix<i128>> for Matrix<u8>{
...
impl Into<Matrix<usize>> for Matrix<u8>{
...
impl Into<Matrix<isize>> for Matrix<u8>{
...
impl Into<Matrix<f32>> for Matrix<u8>{
...
impl Into<Matrix<f64>> for Matrix<u8>{
